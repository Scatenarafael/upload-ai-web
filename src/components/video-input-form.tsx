  ...
  return (
    <form onSubmit={handleUploadVideo} className="space-y-6">
      ...
      <div className="space-y-2">
        <Label htmlFor="transcription_prompt" className="" >Prompt de Transcrição</Label>
        <Textarea
      ...
      <Button type="submit" className="w-full data-[success=true]:bg-emerald-400" disabled={status !== 'waiting'} data-success={status === 'success'}>
        {
          status === 'waiting' ? (
            <>
              Carregar vídeo
